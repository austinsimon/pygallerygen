...
inputFolder = input("Where are the photo folders located? ")
outputFolder = input("What directory should the files be created in? ")
...
for folder in os.listdir(inputFolder):
    if not folder.startswith('.'):
        ...
        if not os.path.exists(outputFolder + "/" + folder + "/photos"):
            os.makedirs(outputFolder + "/" + folder + "/photos")

        outputLocation = outputFolder + "/" + folder + "/index.html"
        ...
        <div class="container">
            <div class="content-p" style="padding-bottom:0px;">
                <div class="row">
                    <div class="col">
                        <h1 class="text-center">""" + folder + """ Gallery</h1>
                    </div>
                </div>
            </div>
            <div class="content-p">
        ...
        for file in os.listdir(inputFolder + "/" + folder):

            if file.endswith(".jpg") or file.endswith(".png"):

                print(file)

                shutil.copy(inputFolder + "/" + folder + "/" + file, outputFolder + "/" + folder + "/photos/")

                HTMLPhoto = """
                <div class="col-md-3">
                    <a href=" """ + "photos/" + file + """ "  data-lightbox="gallery">
                        <div class="card" style="width: 100%;">
                            <img class="card-img-top" src=" """ + "photos/" + file + """ " alt="loading...">
                        </div>
                    </a>
                </div>
                """
